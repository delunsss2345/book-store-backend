...
export class PineconeService {
    ...
    async queryBooks(
        ...
        try {
            ...
            throw new InternalServerErrorException('Pinecone query books failed');
        }
    }
    ...
    async fullReindexBooks(batchSize = DEFAULT_BATCH_SIZE) {
        ...
        try {
            ...
            this.logger.error(error);
            throw new InternalServerErrorException('Pinecone reindex books failed');
        }
    ...
    private toEmbeddingSource(row: SearchIndexVariantRow): BookVariantEmbeddingSource {
