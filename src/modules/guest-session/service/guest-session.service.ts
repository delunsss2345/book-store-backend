...
import { GuestSessionCleanupResult, GuestSessionRepository } from '../repository/guest-session.repository';

@Injectable()
export class GuestSessionService {
    constructor(private readonly guestSessionRepository: GuestSessionRepository) { }

    convertGuestSessionToUser(guestSessionId: string, userId: number) {
