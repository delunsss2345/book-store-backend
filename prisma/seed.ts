...
const CATEGORIES: SeedCategory[] = [
    { slug: 'technology', sortOrder: 1, viName: 'Công nghệ', enName: 'Technology', viDescription: 'Nhóm sách về công nghệ hiện đại, gồm lập trình, vận hành hệ thống, bảo mật và dữ liệu.', enDescription: 'Technology books covering programming, infrastructure, security, and modern data systems.' },
    { slug: 'programming', sortOrder: 2, parentSlug: 'technology', viName: 'Lập trình', enName: 'Programming', viDescription: 'Sách tập trung kỹ thuật coding thực chiến, clean code, testing và tối ưu chất lượng phần mềm.', enDescription: 'Hands-on coding books focused on clean code, testing, and practical engineering quality.' },
    { slug: 'software-architecture', sortOrder: 3, parentSlug: 'technology', viName: 'Kiến trúc phần mềm', enName: 'Software Architecture', viDescription: 'Nội dung về kiến trúc hệ thống, phân rã domain, mở rộng và vận hành ổn định trên quy mô lớn.', enDescription: 'Software architecture, domain boundaries, scalability, and resilient system design at scale.' },
    { slug: 'devops-cloud', sortOrder: 4, parentSlug: 'technology', viName: 'DevOps và Cloud', enName: 'DevOps & Cloud', viDescription: 'Sách về CI/CD, container, cloud native và quản trị hạ tầng theo hướng tự động hóa.', enDescription: 'DevOps and cloud-native books on CI/CD, containers, automation, and infrastructure operations.' },
    { slug: 'cybersecurity', sortOrder: 5, parentSlug: 'technology', viName: 'An toàn thông tin', enName: 'Cybersecurity', viDescription: 'Kiến thức về phòng thủ ứng dụng, quản lý rủi ro và triển khai bảo mật trong vòng đời sản phẩm.', enDescription: 'Cybersecurity practices for secure-by-design software, threat modeling, and risk management.' },
    { slug: 'data-ai', sortOrder: 6, parentSlug: 'technology', viName: 'Dữ liệu và AI', enName: 'Data & AI', viDescription: 'Sách về data engineering, phân tích dữ liệu và ứng dụng machine learning cho bài toán thực tế.', enDescription: 'Data engineering, analytics, and applied AI books for production-ready decision systems.' },

    { slug: 'business-economics', sortOrder: 7, viName: 'Kinh doanh và kinh tế', enName: 'Business & Economics', viDescription: 'Nhóm sách về tăng trưởng doanh nghiệp, vận hành, chiến lược sản phẩm và mô hình tài chính.', enDescription: 'Business and economics titles about growth, operations, product strategy, and financial models.' },
    { slug: 'entrepreneurship', sortOrder: 8, parentSlug: 'business-economics', viName: 'Khởi nghiệp', enName: 'Entrepreneurship', viDescription: 'Sách cho nhà sáng lập: xác thực ý tưởng, tìm product-market fit và xây dựng đội ngũ ban đầu.', enDescription: 'Entrepreneurship books on validation, product-market fit, and early team execution.' },
    { slug: 'management-leadership', sortOrder: 9, parentSlug: 'business-economics', viName: 'Quản trị và lãnh đạo', enName: 'Management & Leadership', viDescription: 'Nội dung về vận hành đội ngũ, đánh giá hiệu suất, lập kế hoạch và ra quyết định lãnh đạo.', enDescription: 'Management and leadership books on team operations, planning, feedback, and decision quality.' },
    { slug: 'marketing-sales', sortOrder: 10, parentSlug: 'business-economics', viName: 'Marketing và bán hàng', enName: 'Marketing & Sales', viDescription: 'Sách hướng dẫn xây dựng thông điệp, kênh tiếp cận và hệ thống chuyển đổi doanh thu ổn định.', enDescription: 'Books on positioning, channel strategy, and conversion-focused marketing and sales execution.' },
    { slug: 'finance-investing', sortOrder: 11, parentSlug: 'business-economics', viName: 'Tài chính và đầu tư', enName: 'Finance & Investing', viDescription: 'Sách tài chính cá nhân, phân tích báo cáo tài chính và các nguyên tắc đầu tư bền vững.', enDescription: 'Finance books covering personal money systems, statement analysis, and long-term investing.' },

    { slug: 'mind-society', sortOrder: 12, viName: 'Tâm trí và xã hội', enName: 'Mind & Society', viDescription: 'Nhóm sách khai phá hành vi con người, bối cảnh xã hội và tư duy để hiểu sâu các quyết định.', enDescription: 'Mind and society books exploring behavior, culture, institutions, and decision dynamics.' },
    { slug: 'psychology', sortOrder: 13, parentSlug: 'mind-society', viName: 'Tâm lý học', enName: 'Psychology', viDescription: 'Sách tâm lý ứng dụng cho học tập, công việc và quản lý bản thân theo hướng thực hành.', enDescription: 'Practical psychology books for habits, motivation, communication, and personal effectiveness.' },
    { slug: 'history', sortOrder: 14, parentSlug: 'mind-society', viName: 'Lịch sử', enName: 'History', viDescription: 'Sách lịch sử theo hướng tổng hợp bối cảnh, nhân quả và bài học cho hiện tại.', enDescription: 'History titles connecting context, causality, and practical lessons for current society.' },
    { slug: 'philosophy', sortOrder: 15, parentSlug: 'mind-society', viName: 'Triết học', enName: 'Philosophy', viDescription: 'Sách triết học ứng dụng giúp làm rõ hệ giá trị, nâng cao năng lực lập luận và phản biện.', enDescription: 'Applied philosophy books for reasoning, ethics, values, and structured critical thinking.' },
    { slug: 'social-issues', sortOrder: 16, parentSlug: 'mind-society', viName: 'Vấn đề xã hội', enName: 'Social Issues', viDescription: 'Sách phân tích những thách thức xã hội đương đại như công dân số, đạo đức dữ liệu và AI.', enDescription: 'Books on modern social issues such as digital citizenship, data ethics, and AI governance.' },

    { slug: 'literature-arts', sortOrder: 17, viName: 'Văn học và nghệ thuật', enName: 'Literature & Arts', viDescription: 'Nhóm sách văn học với giá trị cảm xúc, ngôn ngữ và nghệ thuật kể chuyện.', enDescription: 'Literature and arts books centered on narrative craft, language, and emotional depth.' },
    { slug: 'fiction', sortOrder: 18, parentSlug: 'literature-arts', viName: 'Tiểu thuyết', enName: 'Fiction', viDescription: 'Tiểu thuyết đương đại và kinh điển, khắc họa nhân vật rõ nét và xung đột đầy sức nặng.', enDescription: 'Fiction titles with strong character arcs, layered conflicts, and memorable narrative voice.' },
    { slug: 'short-stories', sortOrder: 19, parentSlug: 'literature-arts', viName: 'Truyện ngắn', enName: 'Short Stories', viDescription: 'Tuyển tập truyện ngắn tinh gọn, giàu hình ảnh và một kết thúc có dư âm.', enDescription: 'Short story collections with concise structure, vivid imagery, and resonant endings.' },
    { slug: 'children-ya', sortOrder: 20, parentSlug: 'literature-arts', viName: 'Thiếu nhi và tuổi mới lớn', enName: 'Children & YA', viDescription: 'Sách cho thiếu nhi và tuổi mới lớn với tính giáo dục, trí tưởng tượng và lòng nhân ái.', enDescription: 'Children and YA books blending imagination, empathy, and age-appropriate life lessons.' },

    { slug: 'education-skills', sortOrder: 21, viName: 'Học tập và kỹ năng', enName: 'Education & Skills', viDescription: 'Nhóm sách hướng dẫn kỹ năng học tập, giao tiếp, ngoại ngữ và nâng cao năng lực cá nhân.', enDescription: 'Education and skills books on learning methods, communication, language, and self-improvement.' },
    { slug: 'language-learning', sortOrder: 22, parentSlug: 'education-skills', viName: 'Học ngoại ngữ', enName: 'Language Learning', viDescription: 'Sách học ngoại ngữ theo ngữ cảnh thực tế, nhanh nhớ và dễ áp dụng trong giao tiếp.', enDescription: 'Language learning books with context-driven methods for practical communication fluency.' },
    { slug: 'productivity-learning', sortOrder: 23, parentSlug: 'education-skills', viName: 'Năng suất và phương pháp học', enName: 'Productivity & Learning', viDescription: 'Sách về quản lý thời gian, tập trung sâu và xây dựng hệ thống học tập bền vững.', enDescription: 'Books on deep focus, time management, and building sustainable long-term learning systems.' },
    { slug: 'communication', sortOrder: 24, parentSlug: 'education-skills', viName: 'Giao tiếp', enName: 'Communication', viDescription: 'Sách rèn luyện kỹ năng trình bày, đàm phán, phản hồi và giao tiếp đa ngữ cảnh.', enDescription: 'Communication books for presentations, negotiation, feedback culture, and collaboration.' },
];
...
const FIXED_USERS: SeedUser[] = [
    { email: 'admin.nguyen@bookstore.local', password: 'Admin@123456', firstName: 'Minh', lastName: 'Nguyễn', phoneNumber: '0901000001', gender: 'male', isEmailVerified: true, roleCodes: [RoleCode.ADMIN] },
    { email: 'staff.lan@bookstore.local', password: 'Staff@123456', firstName: 'Lan', lastName: 'Trần', phoneNumber: '0901000002', gender: 'female', isEmailVerified: true, roleCodes: [RoleCode.STAFF] },
    { email: 'staff.hoang@bookstore.local', password: 'Staff@123456', firstName: 'Hoàng', lastName: 'Phạm', phoneNumber: '0901000003', gender: 'male', isEmailVerified: true, roleCodes: [RoleCode.STAFF] },
    { email: 'warehouse.khoa@bookstore.local', password: 'Warehouse@123456', firstName: 'Khoa', lastName: 'Lê', phoneNumber: '0901000004', gender: 'male', isEmailVerified: true, roleCodes: [RoleCode.WAREHOUSE] },
];
...
const BASE_BOOKS: BaseBook[] = [
    { title: 'Clean Code', author: 'Robert C. Martin', publisher: 'Prentice Hall', publicationYear: 2008, pageCount: 464, categorySlugs: ['programming'], priceVnd: 320000, descriptionVi: 'Cuốn sách kinh điển về viết mã sạch, dễ đọc và dễ bảo trì.', descriptionEn: 'A classic guide to writing readable and maintainable code.' },
    { title: 'The Pragmatic Programmer', author: 'David Thomas, Andrew Hunt', publisher: 'Addison-Wesley', publicationYear: 2019, pageCount: 352, categorySlugs: ['programming'], priceVnd: 350000, descriptionVi: 'Bộ nguyên tắc thực hành giúp lập trình viên chuyên nghiệp hơn.', descriptionEn: 'Practical principles for becoming a more effective software developer.' },
    { title: 'Design Patterns', author: 'Erich Gamma, Richard Helm, Ralph Johnson, John Vlissides', publisher: 'Addison-Wesley', publicationYear: 1994, pageCount: 395, categorySlugs: ['software-architecture', 'programming'], priceVnd: 380000, descriptionVi: 'Tác phẩm nền tảng về 23 mẫu thiết kế hướng đối tượng.', descriptionEn: 'The foundational text introducing classic object-oriented design patterns.' },
    { title: 'Refactoring', author: 'Martin Fowler', publisher: 'Addison-Wesley', publicationYear: 2018, pageCount: 448, categorySlugs: ['programming', 'software-architecture'], priceVnd: 360000, descriptionVi: 'Hướng dẫn cải thiện cấu trúc mã nguồn mà không đổi hành vi.', descriptionEn: 'A guide to improving code structure without changing behavior.' },
    { title: 'Clean Architecture', author: 'Robert C. Martin', publisher: 'Prentice Hall', publicationYear: 2017, pageCount: 432, categorySlugs: ['software-architecture'], priceVnd: 340000, descriptionVi: 'Nguyên lý thiết kế kiến trúc phần mềm linh hoạt và dễ bảo trì.', descriptionEn: 'Design principles for flexible and maintainable architecture.' },
    { title: 'Building Microservices', author: 'Sam Newman', publisher: "O'Reilly Media", publicationYear: 2021, pageCount: 600, categorySlugs: ['software-architecture', 'devops-cloud'], priceVnd: 420000, descriptionVi: 'Hướng dẫn thiết kế và vận hành hệ thống microservices.', descriptionEn: 'A comprehensive guide to microservices design and operations.' },
    { title: 'Designing Data-Intensive Applications', author: 'Martin Kleppmann', publisher: "O'Reilly Media", publicationYear: 2017, pageCount: 616, categorySlugs: ['software-architecture', 'data-ai'], priceVnd: 450000, descriptionVi: 'Phân tích sâu về hệ thống dữ liệu phân tán và khả năng mở rộng.', descriptionEn: 'A deep dive into distributed data systems and scalability.' },
    { title: 'The DevOps Handbook', author: 'Gene Kim, Jez Humble, Patrick Debois, John Willis', publisher: 'IT Revolution Press', publicationYear: 2016, pageCount: 480, categorySlugs: ['devops-cloud'], priceVnd: 390000, descriptionVi: 'Hướng dẫn xây dựng văn hóa DevOps và cải thiện triển khai.', descriptionEn: 'A practical guide to DevOps culture and delivery improvement.' },
    { title: 'Kubernetes Up and Running', author: 'Kelsey Hightower, Brendan Burns, Joe Beda', publisher: "O'Reilly Media", publicationYear: 2019, pageCount: 277, categorySlugs: ['devops-cloud'], priceVnd: 410000, descriptionVi: 'Giới thiệu thực tiễn về triển khai ứng dụng trên Kubernetes.', descriptionEn: 'A practical introduction to running applications on Kubernetes.' },
    { title: 'Site Reliability Engineering', author: 'Betsy Beyer, Chris Jones, Jennifer Petoff, Niall Murphy', publisher: "O'Reilly Media", publicationYear: 2016, pageCount: 552, categorySlugs: ['devops-cloud', 'software-architecture'], priceVnd: 430000, descriptionVi: 'Cách vận hành hệ thống quy mô lớn với độ tin cậy cao.', descriptionEn: 'Practices for running large-scale reliable systems.' },
    { title: 'Web Application Hacker\'s Handbook', author: 'Dafydd Stuttard, Marcus Pinto', publisher: 'Wiley', publicationYear: 2011, pageCount: 912, categorySlugs: ['cybersecurity'], priceVnd: 480000, descriptionVi: 'Cẩm nang phát hiện và khai thác lỗ hổng ứng dụng web.', descriptionEn: 'A detailed guide to finding and exploiting web application flaws.' },
    { title: 'Applied Cryptography', author: 'Bruce Schneier', publisher: 'Wiley', publicationYear: 2015, pageCount: 784, categorySlugs: ['cybersecurity'], priceVnd: 460000, descriptionVi: 'Tài liệu tham khảo về thuật toán và giao thức mật mã ứng dụng.', descriptionEn: 'A comprehensive reference on applied cryptography.' },
    { title: 'Python for Data Analysis', author: 'Wes McKinney', publisher: "O'Reilly Media", publicationYear: 2017, pageCount: 550, categorySlugs: ['data-ai', 'programming'], priceVnd: 400000, descriptionVi: 'Hướng dẫn xử lý và phân tích dữ liệu bằng Python và pandas.', descriptionEn: 'A guide to data wrangling and analysis with Python and pandas.' },
    { title: 'Hands-On Machine Learning', author: 'Aurélien Géron', publisher: "O'Reilly Media", publicationYear: 2019, pageCount: 819, categorySlugs: ['data-ai'], priceVnd: 470000, descriptionVi: 'Hướng dẫn thực hành xây dựng mô hình machine learning.', descriptionEn: 'A hands-on guide to building machine learning models.' },
    { title: 'Deep Learning', author: 'Ian Goodfellow, Yoshua Bengio, Aaron Courville', publisher: 'MIT Press', publicationYear: 2016, pageCount: 800, categorySlugs: ['data-ai'], priceVnd: 520000, descriptionVi: 'Giáo trình nền tảng toàn diện về deep learning.', descriptionEn: 'A comprehensive foundational textbook on deep learning.' },
    { title: 'Introduction to Algorithms', author: 'Thomas H. Cormen, Charles E. Leiserson, Ronald L. Rivest, Clifford Stein', publisher: 'MIT Press', publicationYear: 2022, pageCount: 1312, categorySlugs: ['programming', 'data-ai'], priceVnd: 550000, descriptionVi: 'Giáo trình thuật toán kinh điển trong khoa học máy tính.', descriptionEn: 'A classic algorithms textbook for computer science.' },
    { title: 'You Don\'t Know JS Yet', author: 'Kyle Simpson', publisher: 'Independently Published', publicationYear: 2020, pageCount: 278, categorySlugs: ['programming'], priceVnd: 220000, descriptionVi: 'Khám phá các phần quan trọng và khó hiểu của JavaScript.', descriptionEn: 'An in-depth exploration of JavaScript language behavior.' },
    { title: 'Database Internals', author: 'Alex Petrov', publisher: "O'Reilly Media", publicationYear: 2019, pageCount: 376, categorySlugs: ['data-ai', 'software-architecture'], priceVnd: 420000, descriptionVi: 'Giải thích cách cơ sở dữ liệu hoạt động bên trong.', descriptionEn: 'An explanation of how database systems work internally.' },
    { title: 'High Performance MySQL', author: 'Silvia Botros, Jeremy Tinley', publisher: "O'Reilly Media", publicationYear: 2021, pageCount: 388, categorySlugs: ['data-ai', 'devops-cloud'], priceVnd: 420000, descriptionVi: 'Tối ưu MySQL cho hiệu năng và vận hành thực tế.', descriptionEn: 'Practical MySQL performance and operations guidance.' },
    { title: 'System Design Interview', author: 'Alex Xu', publisher: 'ByteByteGo', publicationYear: 2020, pageCount: 322, categorySlugs: ['software-architecture'], priceVnd: 320000, descriptionVi: 'Các bài toán thiết kế hệ thống phổ biến trong phỏng vấn.', descriptionEn: 'Common system design interview problems and solutions.' },

    { title: 'The Lean Startup', author: 'Eric Ries', publisher: 'Crown Business', publicationYear: 2011, pageCount: 336, categorySlugs: ['entrepreneurship', 'business-economics'], priceVnd: 250000, descriptionVi: 'Phương pháp khởi nghiệp tinh gọn để kiểm chứng ý tưởng nhanh.', descriptionEn: 'A lean methodology for validating startup ideas quickly.' },
    { title: 'Zero to One', author: 'Peter Thiel, Blake Masters', publisher: 'Crown Business', publicationYear: 2014, pageCount: 224, categorySlugs: ['entrepreneurship'], priceVnd: 230000, descriptionVi: 'Quan điểm về xây dựng doanh nghiệp tạo giá trị đột phá.', descriptionEn: 'A perspective on building companies that create breakthrough value.' },
    { title: 'The Hard Thing About Hard Things', author: 'Ben Horowitz', publisher: 'Harper Business', publicationYear: 2014, pageCount: 304, categorySlugs: ['entrepreneurship', 'management-leadership'], priceVnd: 260000, descriptionVi: 'Bài học thực tế khi xây dựng và điều hành công ty.', descriptionEn: 'Hard-won lessons about building and running a company.' },
    { title: 'Good to Great', author: 'Jim Collins', publisher: 'HarperBusiness', publicationYear: 2001, pageCount: 320, categorySlugs: ['management-leadership', 'business-economics'], priceVnd: 270000, descriptionVi: 'Nghiên cứu về cách công ty chuyển từ tốt sang vĩ đại.', descriptionEn: 'A research-driven look at companies that move from good to great.' },
    { title: 'Measure What Matters', author: 'John Doerr', publisher: 'Portfolio', publicationYear: 2018, pageCount: 320, categorySlugs: ['management-leadership', 'business-economics'], priceVnd: 280000, descriptionVi: 'Phương pháp OKR để đặt mục tiêu và đo lường kết quả.', descriptionEn: 'The OKR methodology for goal-setting and execution.' },
    { title: 'Radical Candor', author: 'Kim Scott', publisher: "St. Martin's Press", publicationYear: 2017, pageCount: 320, categorySlugs: ['management-leadership', 'communication'], priceVnd: 260000, descriptionVi: 'Lãnh đạo hiệu quả bằng quan tâm cá nhân và phản hồi thẳng thắn.', descriptionEn: 'Leadership through personal care and direct feedback.' },
    { title: 'Crossing the Chasm', author: 'Geoffrey A. Moore', publisher: 'Harper Business', publicationYear: 2014, pageCount: 254, categorySlugs: ['marketing-sales', 'entrepreneurship'], priceVnd: 260000, descriptionVi: 'Chiến lược đưa sản phẩm công nghệ vào thị trường đại chúng.', descriptionEn: 'A strategy for taking technology products into mainstream markets.' },
    { title: 'Influence', author: 'Robert B. Cialdini', publisher: 'Harper Business', publicationYear: 2006, pageCount: 336, categorySlugs: ['marketing-sales', 'psychology'], priceVnd: 240000, descriptionVi: 'Các nguyên tắc tâm lý ảnh hưởng đến quyết định con người.', descriptionEn: 'Psychological principles that influence human decisions.' },
    { title: 'This Is Marketing', author: 'Seth Godin', publisher: 'Portfolio', publicationYear: 2018, pageCount: 256, categorySlugs: ['marketing-sales'], priceVnd: 220000, descriptionVi: 'Tiếp thị hiện đại tập trung vào giá trị thật cho khách hàng.', descriptionEn: 'A modern view of marketing focused on real customer value.' },
    { title: 'The Intelligent Investor', author: 'Benjamin Graham', publisher: 'Harper Business', publicationYear: 2006, pageCount: 640, categorySlugs: ['finance-investing'], priceVnd: 300000, descriptionVi: 'Nền tảng kinh điển của đầu tư giá trị.', descriptionEn: 'A classic foundation of value investing.' },
    { title: 'Rich Dad Poor Dad', author: 'Robert T. Kiyosaki', publisher: 'Plata Publishing', publicationYear: 2017, pageCount: 258, categorySlugs: ['finance-investing'], priceVnd: 180000, descriptionVi: 'Bài học tài chính cá nhân qua câu chuyện hai người cha.', descriptionEn: 'Personal finance lessons through two contrasting father figures.' },
    { title: 'The Psychology of Money', author: 'Morgan Housel', publisher: 'Harriman House', publicationYear: 2020, pageCount: 256, categorySlugs: ['finance-investing', 'psychology'], priceVnd: 210000, descriptionVi: 'Tâm lý và hành vi ảnh hưởng đến quyết định tài chính.', descriptionEn: 'How behavior and psychology shape financial decisions.' },
    { title: 'A Random Walk Down Wall Street', author: 'Burton G. Malkiel', publisher: 'W. W. Norton & Company', publicationYear: 2023, pageCount: 464, categorySlugs: ['finance-investing'], priceVnd: 290000, descriptionVi: 'Phân tích chiến lược đầu tư và lý do đầu tư chỉ số hiệu quả.', descriptionEn: 'An analysis of investing strategies and index investing.' },
    { title: 'Principles', author: 'Ray Dalio', publisher: 'Simon & Schuster', publicationYear: 2017, pageCount: 592, categorySlugs: ['business-economics', 'management-leadership'], priceVnd: 320000, descriptionVi: 'Nguyên tắc sống và làm việc từ kinh nghiệm quản lý quỹ.', descriptionEn: 'Life and work principles from running a large investment firm.' },

    { title: 'Thinking, Fast and Slow', author: 'Daniel Kahneman', publisher: 'Farrar, Straus and Giroux', publicationYear: 2013, pageCount: 499, categorySlugs: ['psychology'], priceVnd: 260000, descriptionVi: 'Khám phá hai hệ thống tư duy chi phối quyết định.', descriptionEn: 'An exploration of two systems of thought that guide decisions.' },
    { title: 'Atomic Habits', author: 'James Clear', publisher: 'Avery', publicationYear: 2018, pageCount: 320, categorySlugs: ['psychology', 'productivity-learning'], priceVnd: 220000, descriptionVi: 'Phương pháp xây dựng thói quen tốt bền vững.', descriptionEn: 'A method for building good habits and breaking bad ones.' },
    { title: 'Mindset', author: 'Carol S. Dweck', publisher: 'Ballantine Books', publicationYear: 2007, pageCount: 320, categorySlugs: ['psychology'], priceVnd: 210000, descriptionVi: 'Phân biệt tư duy cố định và tư duy phát triển.', descriptionEn: 'The difference between fixed and growth mindsets.' },
    { title: 'The Body Keeps the Score', author: 'Bessel van der Kolk', publisher: 'Viking', publicationYear: 2014, pageCount: 464, categorySlugs: ['psychology'], priceVnd: 280000, descriptionVi: 'Nghiên cứu tác động của sang chấn lên cơ thể và tâm trí.', descriptionEn: 'A study of trauma and its impact on body and mind.' },
    { title: 'Man\'s Search for Meaning', author: 'Viktor E. Frankl', publisher: 'Beacon Press', publicationYear: 2006, pageCount: 184, categorySlugs: ['psychology', 'philosophy'], priceVnd: 150000, descriptionVi: 'Hồi ký và triết lý sống về ý nghĩa.', descriptionEn: 'A memoir and philosophy about meaning.' },
    { title: 'Sapiens', author: 'Yuval Noah Harari', publisher: 'Harper', publicationYear: 2015, pageCount: 464, categorySlugs: ['history', 'mind-society'], priceVnd: 270000, descriptionVi: 'Lịch sử loài người từ săn bắt hái lượm đến hiện đại.', descriptionEn: 'A sweeping history of humankind.' },
    { title: 'Guns, Germs, and Steel', author: 'Jared Diamond', publisher: 'W. W. Norton & Company', publicationYear: 1999, pageCount: 480, categorySlugs: ['history'], priceVnd: 260000, descriptionVi: 'Giải thích vì sao các nền văn minh phát triển khác nhau.', descriptionEn: 'An explanation of why civilizations developed differently.' },
    { title: 'Meditations', author: 'Marcus Aurelius', publisher: 'Modern Library', publicationYear: 2003, pageCount: 304, categorySlugs: ['philosophy'], priceVnd: 160000, descriptionVi: 'Suy ngẫm khắc kỷ về cách sống đức hạnh.', descriptionEn: 'Stoic reflections on living a virtuous life.' },
    { title: 'The Republic', author: 'Plato', publisher: 'Penguin Classics', publicationYear: 2007, pageCount: 416, categorySlugs: ['philosophy'], priceVnd: 170000, descriptionVi: 'Đối thoại triết học về công lý và nhà nước lý tưởng.', descriptionEn: 'A classic dialogue about justice and the ideal state.' },
    { title: 'The Art of War', author: 'Sun Tzu', publisher: 'Shambhala', publicationYear: 2005, pageCount: 273, categorySlugs: ['philosophy', 'management-leadership'], priceVnd: 150000, descriptionVi: 'Binh pháp cổ được ứng dụng trong lãnh đạo và kinh doanh.', descriptionEn: 'An ancient strategy text applied to leadership and business.' },
    { title: 'Weapons of Math Destruction', author: 'Cathy O\'Neil', publisher: 'Crown', publicationYear: 2016, pageCount: 272, categorySlugs: ['social-issues', 'data-ai'], priceVnd: 230000, descriptionVi: 'Cảnh báo về thuật toán dữ liệu lớn và bất công xã hội.', descriptionEn: 'A warning on how data algorithms can amplify inequality.' },

    { title: '1984', author: 'George Orwell', publisher: 'Signet Classics', publicationYear: 1961, pageCount: 328, categorySlugs: ['fiction'], priceVnd: 150000, descriptionVi: 'Tiểu thuyết phản địa đàng về giám sát và kiểm soát.', descriptionEn: 'A dystopian novel about surveillance and control.' },
    { title: 'To Kill a Mockingbird', author: 'Harper Lee', publisher: 'Harper Perennial', publicationYear: 2002, pageCount: 336, categorySlugs: ['fiction'], priceVnd: 160000, descriptionVi: 'Câu chuyện về công lý và phân biệt chủng tộc.', descriptionEn: 'A story about justice and racial inequality.' },
    { title: 'The Great Gatsby', author: 'F. Scott Fitzgerald', publisher: 'Scribner', publicationYear: 2004, pageCount: 180, categorySlugs: ['fiction'], priceVnd: 130000, descriptionVi: 'Bi kịch về giấc mơ Mỹ thời Jazz Age.', descriptionEn: 'A tragic portrait of the American Dream.' },
    { title: 'Pride and Prejudice', author: 'Jane Austen', publisher: 'Penguin Classics', publicationYear: 2003, pageCount: 480, categorySlugs: ['fiction'], priceVnd: 140000, descriptionVi: 'Tiểu thuyết kinh điển về định kiến và hôn nhân.', descriptionEn: 'A classic romantic novel about prejudice and marriage.' },
    { title: 'One Hundred Years of Solitude', author: 'Gabriel García Márquez', publisher: 'Harper Perennial', publicationYear: 2006, pageCount: 417, categorySlugs: ['fiction'], priceVnd: 180000, descriptionVi: 'Hiện thực huyền ảo về nhiều thế hệ gia đình Buendía.', descriptionEn: 'A magical realist saga of the Buendía family.' },
    { title: 'Crime and Punishment', author: 'Fyodor Dostoevsky', publisher: 'Vintage Classics', publicationYear: 1993, pageCount: 560, categorySlugs: ['fiction'], priceVnd: 190000, descriptionVi: 'Hành trình tâm lý của một sinh viên sau tội ác.', descriptionEn: 'A psychologically intense journey after a crime.' },
    { title: 'Harry Potter and the Sorcerer\'s Stone', author: 'J. K. Rowling', publisher: 'Scholastic', publicationYear: 1998, pageCount: 309, categorySlugs: ['children-ya', 'fiction'], priceVnd: 170000, descriptionVi: 'Khởi đầu hành trình phép thuật tại Hogwarts.', descriptionEn: 'The beginning of a magical journey at Hogwarts.' },
    { title: 'The Hobbit', author: 'J. R. R. Tolkien', publisher: 'Houghton Mifflin Harcourt', publicationYear: 2012, pageCount: 300, categorySlugs: ['children-ya', 'fiction'], priceVnd: 170000, descriptionVi: 'Cuộc phiêu lưu của Bilbo Baggins cùng các chú lùn.', descriptionEn: 'Bilbo Baggins\' adventure with dwarves.' },
    { title: 'The Little Prince', author: 'Antoine de Saint-Exupéry', publisher: 'Harcourt', publicationYear: 2000, pageCount: 96, categorySlugs: ['children-ya', 'fiction'], priceVnd: 100000, descriptionVi: 'Ngụ ngôn triết lý về tình yêu và bản chất con người.', descriptionEn: 'A philosophical fable about love and human nature.' },
    { title: 'Norwegian Wood', author: 'Haruki Murakami', publisher: 'Vintage International', publicationYear: 2000, pageCount: 296, categorySlugs: ['fiction', 'literature-arts'], priceVnd: 160000, descriptionVi: 'Câu chuyện tình yêu và mất mát của sinh viên Nhật Bản.', descriptionEn: 'A poetic story of love and loss.' },
    { title: 'Animal Farm', author: 'George Orwell', publisher: 'Signet Classics', publicationYear: 1996, pageCount: 141, categorySlugs: ['fiction', 'social-issues'], priceVnd: 110000, descriptionVi: 'Ngụ ngôn chính trị về quyền lực và tha hóa.', descriptionEn: 'A political fable about power and corruption.' },
    { title: 'The Alchemist', author: 'Paulo Coelho', publisher: 'HarperOne', publicationYear: 2014, pageCount: 208, categorySlugs: ['fiction', 'philosophy'], priceVnd: 150000, descriptionVi: 'Hành trình theo đuổi vận mệnh và lắng nghe trái tim.', descriptionEn: 'A journey of destiny and listening to the heart.' },

    { title: 'Make It Stick', author: 'Peter C. Brown, Henry L. Roediger III, Mark A. McDaniel', publisher: 'Belknap Press', publicationYear: 2014, pageCount: 336, categorySlugs: ['productivity-learning', 'education-skills'], priceVnd: 250000, descriptionVi: 'Nghiên cứu về phương pháp học hiệu quả và ghi nhớ lâu.', descriptionEn: 'Research-backed effective learning strategies.' },
    { title: 'Deep Work', author: 'Cal Newport', publisher: 'Grand Central Publishing', publicationYear: 2016, pageCount: 304, categorySlugs: ['productivity-learning'], priceVnd: 230000, descriptionVi: 'Phương pháp làm việc tập trung sâu trong thời đại phân tán.', descriptionEn: 'A method for focused work in a distracted world.' },
    { title: 'Getting Things Done', author: 'David Allen', publisher: 'Penguin Books', publicationYear: 2015, pageCount: 352, categorySlugs: ['productivity-learning'], priceVnd: 240000, descriptionVi: 'Hệ thống quản lý công việc và thời gian.', descriptionEn: 'A system for managing work and time.' },
    { title: 'How to Win Friends and Influence People', author: 'Dale Carnegie', publisher: 'Simon & Schuster', publicationYear: 1998, pageCount: 291, categorySlugs: ['communication', 'psychology'], priceVnd: 200000, descriptionVi: 'Nguyên tắc giao tiếp kinh điển để xây dựng quan hệ.', descriptionEn: 'Classic communication principles for relationships.' },
    { title: 'Crucial Conversations', author: 'Kerry Patterson, Joseph Grenny, Ron McMillan, Al Switzler', publisher: 'McGraw-Hill', publicationYear: 2011, pageCount: 256, categorySlugs: ['communication', 'management-leadership'], priceVnd: 250000, descriptionVi: 'Kỹ năng xử lý các cuộc trò chuyện khó.', descriptionEn: 'Skills for handling high-stakes conversations.' },
    { title: 'Never Split the Difference', author: 'Chris Voss, Tahl Raz', publisher: 'Harper Business', publicationYear: 2016, pageCount: 288, categorySlugs: ['communication', 'business-economics'], priceVnd: 240000, descriptionVi: 'Kỹ thuật đàm phán từ chuyên gia FBI.', descriptionEn: 'Negotiation tactics from a former FBI negotiator.' },
    { title: 'English Grammar in Use', author: 'Raymond Murphy', publisher: 'Cambridge University Press', publicationYear: 2019, pageCount: 380, categorySlugs: ['language-learning'], priceVnd: 280000, descriptionVi: 'Sách ngữ pháp tiếng Anh tự học phổ biến.', descriptionEn: 'A popular self-study English grammar book.' },
    { title: '504 Absolutely Essential Words', author: 'Murray Bromberg, Melvin Gordon', publisher: "Barron's Educational Series", publicationYear: 2013, pageCount: 442, categorySlugs: ['language-learning'], priceVnd: 200000, descriptionVi: 'Bộ từ vựng tiếng Anh thiết yếu theo chủ đề.', descriptionEn: 'Essential English vocabulary organized by theme.' },
    { title: 'Fluent Forever', author: 'Gabriel Wyner', publisher: 'Harmony', publicationYear: 2014, pageCount: 336, categorySlugs: ['language-learning'], priceVnd: 230000, descriptionVi: 'Phương pháp học ngoại ngữ dựa trên trí nhớ và ngữ âm.', descriptionEn: 'A language learning method based on memory science.' },
];
...
function buildBooks() {
    ...
    for (let index = 0; index < BOOK_COUNT; index += 1) {
        ...
        books.push({
            ...base,
            title: round === 0 ? base.title : `${base.title} - Special Edition ${round + 1}`,
            titleVi: round === 0 ? base.titleVi : `${base.titleVi ?? base.title} - Bản đặc biệt ${round + 1}`,
            isbn13,
            publicationYear: Math.min(2026, Math.max(1950, base.publicationYear + (round % 3))),
