...
CREATE TABLE `book_translations` (
    ...
    FULLTEXT INDEX `idx_book_translation_fulltext`(`title`, `description`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `book_variants` (
    ...
    `currency_code` ENUM('VND', 'USD', 'EUR', 'GBP', 'JPY', 'SGD', 'THB', 'AUD', 'CAD', 'KRW') NOT NULL DEFAULT 'VND',
...
CREATE TABLE `book_variant_snapshots` (
    ...
    `currency_code_snapshot` ENUM('VND', 'USD', 'EUR', 'GBP', 'JPY', 'SGD', 'THB', 'AUD', 'CAD', 'KRW') NOT NULL DEFAULT 'VND',
...
CREATE TABLE `user_events` (
    ...
    `currency_code` ENUM('VND', 'USD', 'EUR', 'GBP', 'JPY', 'SGD', 'THB', 'AUD', 'CAD', 'KRW') NULL DEFAULT 'VND',
    `ip` VARCHAR(64) NULL,
    `user_agent` VARCHAR(1000) NULL,
    `metadata` JSON NULL,
    `created_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
