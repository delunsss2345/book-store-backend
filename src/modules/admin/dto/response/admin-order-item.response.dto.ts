import { OrderAddressDto } from './admin-address.response.dto';
import { UserAddressResponseDto } from './admin-user-address.response.dto';
import { ApiProperty, ApiPropertyOptional } from '@nestjs/swagger';

export class AdminOrderUserSummaryResponseDto {
...
export class AdminOrderItemBaseResponseDto {
...
export class AdminGuestOrderItemResponseDto extends AdminOrderItemBaseResponseDto {
...
export class AdminUserOrderItemResponseDto extends AdminOrderItemBaseResponseDto {
  @ApiPropertyOptional({ example: '8' })
  userId: string | null;

  @ApiPropertyOptional({
    type: () => AdminOrderUserSummaryResponseDto,
    nullable: true,
  })
  user: AdminOrderUserSummaryResponseDto | null;

  @ApiPropertyOptional({ type: () => UserAddressResponseDto, nullable: true })
  addressUser: UserAddressResponseDto | null;
}
